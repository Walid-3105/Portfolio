...
const About = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-14 p-8">
      ...
      <div className="p-4 items-center space-y-2">
        ...
        <p>
          ...
          tenetur similique velit mollitia vel minus alias! Nihil esse repellat
          placeat aliquid asperiores laborum aliquam voluptatem id, saepe,
          reiciendis aperiam.
        </p>
      </div>
    </div>
